...
router.post('/create', scheduleService.createEvent);

/* GET - Get all Schedule listings. */
router.get('/', scheduleService.getSchedule);

/* POST - Update Schedule listing. */
router.post('/update', scheduleService.updateEvent);

/* DELETE - Delete Schedule listing. */
router.delete('/delete', scheduleService.deleteEvent);

/* POST - Import and replace all Schedule listings. */
router.post('/import', scheduleService.importSchedule);
